            ...
            <ul class="thumbnails mainimage">
                ...
                <li class="span5">
                    <a  rel="position: 'inside' , showTitle: false, adjustX:-4, adjustY:-4" class="thumbnail cloud-zoom" href="{!! asset('resources/upload/detail/'.$item_image->image) !!}">
                        <img  src="{!! asset('upload/detail/'.$item_image->image) !!}" alt="" title="">
                    </a>
                </li>
                @endforeach
            </ul>
...
<section id="related" class="row">
    <div class="container">
        ...
        <ul class="thumbnails">
            @foreach($product_cate as $item_product_relate)
            <li class="span3">
                ...
                <div class="thumbnail">
                    ...
                    <div class="pricetag">
                        ...
                        <div class="price">
                            <div class="pricenew">{!! number_format($item_product_relate->price, 0, ",", ".") !!}</div>
